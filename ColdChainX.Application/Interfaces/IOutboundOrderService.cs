...
namespace ColdChainX.Application.Interfaces
{
    public interface IOutboundOrderService
    {
        ...
        Task<ApiResponse<PagedResult<OutboundOrderResponse>>> GetListAsync(int pageNumber, int pageSize, string? search = null);
        ...
        Task<ApiResponse<OutboundOrderResponse>> CompleteOrderAsync(Guid outboundOrderId, Guid userId);
    }
}
