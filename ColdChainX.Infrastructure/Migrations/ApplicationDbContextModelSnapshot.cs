...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.AlertLog", b =>
                {
                    ...
                    b.HasIndex(new[] { "TripId", "CreatedAt" }, "ix_alert_logs_trip_created_at");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.ChatMessage", b =>
                {
                    ...
                    b.HasIndex(new[] { "ReceiverId", "IsRead", "CreatedAt" }, "ix_chat_messages_receiver_read_created_at");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.Claim", b =>
                {
                    ...
                    b.HasIndex(new[] { "Status", "CreatedAt" }, "ix_claims_status_created_at");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.CustomerContract", b =>
                {
                    ...
                    b.Property<decimal?>("FinalContractTotalAmount")
                    ...
                    b.Property<string>("SelectedOptionalServices")
                        .HasColumnType("text");
                    ...
                    b.HasIndex(new[] { "CreatedAt" }, "ix_customer_contracts_created_at");

                    b.HasIndex(new[] { "CustomerId", "CreatedAt" }, "ix_customer_contracts_customer_created_at");

                    b.HasIndex("CustomerId");

                    b.HasIndex(new[] { "Status", "CreatedAt" }, "ix_customer_contracts_status_created_at");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.DetentionCharge", b =>
                {
                    ...
                    b.Property<int>("FreeMinutesAllocated")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("DetentionCharges", "public");
                });

            modelBuilder.Entity("ColdChainX.Core.Entities.DeviceToken", b =>
                {
                    ...
                    b.HasIndex(new[] { "Token" }, "device_tokens_token_key")
                        .IsUnique();

                    b.HasIndex(new[] { "UserId", "IsActive" }, "ix_device_tokens_user_active");

                    b.HasIndex(new[] { "UserId", "DeviceId" }, "ix_device_tokens_user_device");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.IncidentEvidence", b =>
                {
                    b.Property<Guid>("EvidenceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.Invoice", b =>
                {
                    ...
                    b.HasIndex(new[] { "IssuedDate", "Status" }, "ix_invoices_issued_status");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.MasterTrip", b =>
                {
                    ...
                    b.HasIndex(new[] { "PlannedStartTime", "Status" }, "ix_master_trips_planned_start_status");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.Notification", b =>
                {
                    ...
                    b.HasIndex(new[] { "UserId", "CreatedAt" }, "ix_notifications_user_created_at");

                    b.HasIndex(new[] { "UserId", "IsRead", "CreatedAt" }, "ix_notifications_user_read_created_at");

                    b.HasIndex(new[] { "UserId", "Type" }, "ix_notifications_user_type");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.PaymentTransaction", b =>
                {
                    ...
                    b.HasIndex(new[] { "CreatedAt" }, "ix_payment_transactions_created_at");

                    b.HasIndex(new[] { "Status", "TransactionType", "PaymentMethod", "CreatedAt" }, "ix_payment_transactions_dashboard_filters");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.Quotation", b =>
                {
                    ...
                    b.Property<string>("MandatoryCharges")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("OptionalServicesMenu")
                        .HasColumnType("text");
                    ...
                    b.HasIndex(new[] { "AcceptedAt" }, "ix_quotations_accepted_at");

                    b.HasIndex(new[] { "CreatedAt" }, "ix_quotations_created_at");

                    b.HasIndex(new[] { "SentAt" }, "ix_quotations_sent_at");

                    b.HasIndex(new[] { "Status", "CreatedAt" }, "ix_quotations_status_created_at");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.RouteSchedule", b =>
                {
                    b.Property<Guid>("ScheduleId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("ScheduleId")
                        .HasName("route_schedules_pkey");

                    b.HasIndex("RouteId");

                    b.ToTable("route_schedules", "public");
                });
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.ServiceCatalog", b =>
                {
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.TripStopEvent", b =>
                {
                    ...
                    b.ToTable("TripStopEvents", "public");
                });
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.UserPermission", b =>
                {
                    ...
                    b.HasIndex(new[] { "ValidTo" }, "ix_user_permissions_valid_to");

                    b.HasIndex(new[] { "UserId", "PermId" }, "user_permissions_user_perm_key")
                        .IsUnique();
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.VehicleDocument", b =>
                {
                    ...
                    b.HasIndex(new[] { "ExpireDate" }, "ix_vehicle_documents_expire_date");

                    b.ToTable("vehicle_documents", "public");
                });

            modelBuilder.Entity("ColdChainX.Core.Entities.VehicleOdometerLog", b =>
                {
                    b.Property<Guid>("LogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("LogId")
                        .HasName("vehicle_odometer_logs_pkey");

                    b.HasIndex("VehicleId");

                    b.ToTable("vehicle_odometer_logs", "public");
                });
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.WorkAssignment", b =>
                {
                    ...
                    b.HasKey("AssignmentId")
                        .HasName("work_assignments_pkey");

                    b.HasIndex(new[] { "AssignedToUserId", "Status" }, "ix_work_assignments_assignee_status");

                    b.HasIndex(new[] { "ReferenceType", "ReferenceId" }, "ix_work_assignments_reference");

                    b.HasIndex(new[] { "WarehouseId", "Status" }, "ix_work_assignments_warehouse_status");

                    b.HasIndex(new[] { "TaskType", "ReferenceType", "ReferenceId", "AssignedToUserId" }, "ux_work_assignments_active_work")
                        .IsUnique()
                        .HasFilter("status IN ('ASSIGNED', 'IN_PROGRESS')");

                    b.ToTable("work_assignments", "public");
                });
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.IncidentEvidence", b =>
                {
                    b.HasOne("ColdChainX.Core.Entities.IncidentReport", "Incident")
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.UserPermission", b =>
                {
                    b.HasOne("ColdChainX.Core.Entities.Permission", "Permission")
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.IncidentReport", b =>
                {
                    b.Navigation("IncidentEvidences");
                });
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.TripStop", b =>
                {
                    b.Navigation("DetentionCharges");

                    b.Navigation("Seals");

                    b.Navigation("TripStopEvents");
                });
