...
namespace ColdChainX.Infrastructure.Migrations
{
    ...
    [Migration("20260619171557_AddManifestPdfUrlToMasterTrip")]
    partial class AddManifestPdfUrlToMasterTrip
    {
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.InboundAsn", b =>
                {
                    ...
                    b.HasKey("AsnId")
                        .HasName("inbound_asns_pkey");

                    b.HasIndex("OrderId");

                    b.ToTable("inbound_asns", "public");
                });
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.ChatMessage", b =>
                {
                    b.HasOne("ColdChainX.Core.Entities.TransportOrder", "Order")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chat_messages_orders");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.InboundAsn", b =>
                {
                    b.HasOne("ColdChainX.Core.Entities.TransportOrder", "Order")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_inbound_asns_orders");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.WeightTier", b =>
                {
                    b.HasOne("ColdChainX.Core.Entities.RouteMaster", "Route")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_weight_tiers_route_master");
