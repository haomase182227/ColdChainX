...
namespace ColdChainX.Infrastructure.Migrations
{
    ...
    [Migration("20260818135003_AddLpnPackageVariantLines")]
    partial class AddLpnPackageVariantLines
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.LpnPackageVariantLine", b =>
                {
                    b.Property<Guid>("LpnPackageVariantLineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("OrderPackageVariantId")
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("LpnPackageVariantLineId")
                        .HasName("lpn_package_variant_lines_pkey");

                    b.HasIndex("LpnId")
                        .HasDatabaseName("idx_lpn_package_variant_lines_lpn_id");

                    b.HasIndex("OrderPackageVariantId")
                        .HasDatabaseName("idx_lpn_package_variant_lines_variant_id");

                    b.ToTable("lpn_package_variant_lines", "public");
                });
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.OrderPackageVariant", b =>
                {
                    b.Property<Guid>("OrderPackageVariantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("ExpectedUnitWeightKg")
                        .HasPrecision(10, 2)
                        .HasColumnType("numeric(10,2)")
                    ...
                    b.HasKey("OrderPackageVariantId")
                        .HasName("order_package_variants_pkey");

                    b.HasIndex(new[] { "OrderId" }, "ix_order_package_variants_order_id");

                    b.ToTable("order_package_variants", "public");
                });
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.LpnPackageVariantLine", b =>
                {
                    b.HasOne("ColdChainX.Core.Entities.Lpn", "Lpn")
                        .WithMany("PackageVariantLines")
                        .HasForeignKey("LpnId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_lpn_package_variant_lines_lpn");

                    b.HasOne("ColdChainX.Core.Entities.OrderPackageVariant", "OrderPackageVariant")
                        .WithMany("LpnPackageVariantLines")
                        .HasForeignKey("OrderPackageVariantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_lpn_package_variant_lines_variant");

                    b.Navigation("Lpn");

                    b.Navigation("OrderPackageVariant");
                });
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.Lpn", b =>
                {
                    b.Navigation("PackageVariantLines");
            ...
            modelBuilder.Entity("ColdChainX.Core.Entities.OrderPackageVariant", b =>
                {
                    b.Navigation("LpnPackageVariantLines");
