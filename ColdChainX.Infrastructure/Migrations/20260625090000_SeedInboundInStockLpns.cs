...
namespace ColdChainX.Infrastructure.Migrations
{
    ...
    public partial class SeedInboundInStockLpns : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                ...
                DECLARE
                    ...
                    order_1_id uuid := '75000000-0000-0000-0000-000000000101';
                    order_2_id uuid := '75000000-0000-0000-0000-000000000102';
                    order_3_id uuid := '75000000-0000-0000-0000-000000000103';

                    receipt_1_id uuid := '76000000-0000-0000-0000-000000000101';
                    receipt_2_id uuid := '76000000-0000-0000-0000-000000000102';
                    receipt_3_id uuid := '76000000-0000-0000-0000-000000000103';
                BEGIN
                    ...
                    SELECT
                        order_1_id, 'SEED-LTL-ORD-001', seed_customer_id, 'Vaccine Cold Box 2-8C', 'PHARMA', 24, 'COLD_BOX', '2-8C',
                    ...
                    WHERE NOT EXISTS (SELECT 1 FROM public.transport_orders WHERE tracking_code = 'SEED-LTL-ORD-001');
                    ...
                    INSERT INTO public.transport_orders
                        (order_id, tracking_code, customer_id, item_name, category, quantity, packing_type, temp_condition,
                         ...
                         pickup_location, dest_location, cargo_value, status, master_trip_id, route_id, created_at)
                    SELECT
                        order_2_id, 'SEED-LTL-ORD-002', seed_customer_id, 'Frozen Seafood Cartons', 'SEAFOOD', 36, 'CARTON', '-25--18C',
                    ...
                    WHERE NOT EXISTS (SELECT 1 FROM public.transport_orders WHERE tracking_code = 'SEED-LTL-ORD-002');
                    ...
                    INSERT INTO public.transport_orders
                        (order_id, tracking_code, customer_id, item_name, category, quantity, packing_type, temp_condition,
                         ...
                         pickup_location, dest_location, cargo_value, status, master_trip_id, route_id, created_at)
                    SELECT
                        order_3_id, 'SEED-LTL-ORD-003', seed_customer_id, 'Chilled Yogurt Pallet', 'FOOD', 48, 'PALLET', '2-8C',
                    ...
                    WHERE NOT EXISTS (SELECT 1 FROM public.transport_orders WHERE tracking_code = 'SEED-LTL-ORD-003');
                    ...
                    SELECT '77000000-0000-0000-0000-000000000101', 'ASN-SEED-LTL-001', order_1_id, TIMESTAMP '2026-06-25 10:00:00', 'ASN|ASN-SEED-LTL-001|ORDER|SEED-LTL-ORD-001', 'RECEIVED', '0900001001', seed_warehouse_id, seed_customer_id, NULL, TIMESTAMP '2026-06-25 09:20:00'
                    WHERE NOT EXISTS (SELECT 1 FROM public.inbound_asn WHERE asn_code = 'ASN-SEED-LTL-001');

                    INSERT INTO public.inbound_asn
                        (asn_id, asn_code, order_id, requested_dropoff_time, qr_code_value, status, phone, warehouse_id, customer_id, file_url, created_at)
                    SELECT '77000000-0000-0000-0000-000000000102', 'ASN-SEED-LTL-002', order_2_id, TIMESTAMP '2026-06-25 10:30:00', 'ASN|ASN-SEED-LTL-002|ORDER|SEED-LTL-ORD-002', 'RECEIVED', '0900001002', seed_warehouse_id, seed_customer_id, NULL, TIMESTAMP '2026-06-25 09:25:00'
                    WHERE NOT EXISTS (SELECT 1 FROM public.inbound_asn WHERE asn_code = 'ASN-SEED-LTL-002');

                    INSERT INTO public.inbound_asn
                        (asn_id, asn_code, order_id, requested_dropoff_time, qr_code_value, status, phone, warehouse_id, customer_id, file_url, created_at)
                    SELECT '77000000-0000-0000-0000-000000000103', 'ASN-SEED-LTL-003', order_3_id, TIMESTAMP '2026-06-25 11:00:00', 'ASN|ASN-SEED-LTL-003|ORDER|SEED-LTL-ORD-003', 'RECEIVED', '0900001003', seed_warehouse_id, seed_customer_id, NULL, TIMESTAMP '2026-06-25 09:30:00'
                    WHERE NOT EXISTS (SELECT 1 FROM public.inbound_asn WHERE asn_code = 'ASN-SEED-LTL-003');
                    ...
                    SELECT receipt_1_id, 'GRN-SEED-LTL-001', 'ASN-SEED-LTL-001', order_1_id, seed_warehouse_id, 'INBOUND', 'Seed inbound completed',
                        24, 24, 4.20, 'Seed Carrier A', receiver_id, 'Seed: received and ready for put-away.', NULL, TIMESTAMP '2026-06-25 10:15:00'
                    WHERE NOT EXISTS (SELECT 1 FROM public.warehouse_receipts WHERE receipt_code = 'GRN-SEED-LTL-001');

                    INSERT INTO public.warehouse_receipts
                        (receipt_id, receipt_code, reference_doc_no, order_id, warehouse_id, receipt_type, reason,
                         total_expected_qty, total_actual_qty, recorded_temperature, deliverer_name, receiver_id, note, pdf_url, created_at)
                    SELECT receipt_2_id, 'GRN-SEED-LTL-002', 'ASN-SEED-LTL-002', order_2_id, seed_warehouse_id, 'INBOUND', 'Seed inbound completed',
                        36, 36, -19.80, 'Seed Carrier B', receiver_id, 'Seed: frozen seafood received and put away.', NULL, TIMESTAMP '2026-06-25 10:45:00'
                    WHERE NOT EXISTS (SELECT 1 FROM public.warehouse_receipts WHERE receipt_code = 'GRN-SEED-LTL-002');

                    INSERT INTO public.warehouse_receipts
                        (receipt_id, receipt_code, reference_doc_no, order_id, warehouse_id, receipt_type, reason,
                         total_expected_qty, total_actual_qty, recorded_temperature, deliverer_name, receiver_id, note, pdf_url, created_at)
                    SELECT receipt_3_id, 'GRN-SEED-LTL-003', 'ASN-SEED-LTL-003', order_3_id, seed_warehouse_id, 'INBOUND', 'Seed inbound completed',
                        48, 48, 5.10, 'Seed Carrier C', receiver_id, 'Seed: chilled food received and put away.', NULL, TIMESTAMP '2026-06-25 11:15:00'
                    WHERE NOT EXISTS (SELECT 1 FROM public.warehouse_receipts WHERE receipt_code = 'GRN-SEED-LTL-003');
                    ...
                    SELECT '78000000-0000-0000-0000-000000000101', 'LPN-SEED-LTL-001', order_1_id, seed_customer_id, receipt_1_id, NULL, NULL, 24, 178.50, 1.1800,
                    ...
                    WHERE NOT EXISTS (SELECT 1 FROM public.lpns WHERE lpn_code = 'LPN-SEED-LTL-001');

                    INSERT INTO public.lpns
                        (lpn_id, lpn_code, order_id, customer_id, receipt_id, route_id, trip_id, quantity, actual_weight_kg, actual_cbm,
                         length_cm, width_cm, height_cm, required_temperature, recorded_temperature, storage_location, state,
                         discrepancy_reason, evidence_image_url, inbound_time, sla_deadline, created_at, updated_at)
                    SELECT '78000000-0000-0000-0000-000000000102', 'LPN-SEED-LTL-002', order_2_id, seed_customer_id, receipt_2_id, NULL, NULL, 20, 286.00, 1.9800,
                    ...
                    WHERE NOT EXISTS (SELECT 1 FROM public.lpns WHERE lpn_code = 'LPN-SEED-LTL-002');

                    INSERT INTO public.lpns
                        (lpn_id, lpn_code, order_id, customer_id, receipt_id, route_id, trip_id, quantity, actual_weight_kg, actual_cbm,
                         length_cm, width_cm, height_cm, required_temperature, recorded_temperature, storage_location, state,
                         discrepancy_reason, evidence_image_url, inbound_time, sla_deadline, created_at, updated_at)
                    SELECT '78000000-0000-0000-0000-000000000103', 'LPN-SEED-LTL-003', order_2_id, seed_customer_id, receipt_2_id, NULL, NULL, 16, 229.00, 1.5600,
                    ...
                    WHERE NOT EXISTS (SELECT 1 FROM public.lpns WHERE lpn_code = 'LPN-SEED-LTL-003');

                    INSERT INTO public.lpns
                        (lpn_id, lpn_code, order_id, customer_id, receipt_id, route_id, trip_id, quantity, actual_weight_kg, actual_cbm,
                         length_cm, width_cm, height_cm, required_temperature, recorded_temperature, storage_location, state,
                         discrepancy_reason, evidence_image_url, inbound_time, sla_deadline, created_at, updated_at)
                    SELECT '78000000-0000-0000-0000-000000000104', 'LPN-SEED-LTL-004', order_3_id, seed_customer_id, receipt_3_id, NULL, NULL, 48, 386.00, 2.7600,
                    ...
                    WHERE NOT EXISTS (SELECT 1 FROM public.lpns WHERE lpn_code = 'LPN-SEED-LTL-004');
                END $$;
                """);
        }
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                """
                DELETE FROM public.lpns
                WHERE lpn_code IN ('LPN-SEED-LTL-001', 'LPN-SEED-LTL-002', 'LPN-SEED-LTL-003', 'LPN-SEED-LTL-004');

                DELETE FROM public.warehouse_receipts
                WHERE receipt_code IN ('GRN-SEED-LTL-001', 'GRN-SEED-LTL-002', 'GRN-SEED-LTL-003');

                DELETE FROM public.inbound_asn
                WHERE asn_code IN ('ASN-SEED-LTL-001', 'ASN-SEED-LTL-002', 'ASN-SEED-LTL-003');

                DELETE FROM public.transport_orders
                WHERE tracking_code IN ('SEED-LTL-ORD-001', 'SEED-LTL-ORD-002', 'SEED-LTL-ORD-003');

                DELETE FROM public.users
                WHERE username = 'seed.receiver';

                DELETE FROM public.warehouses
                WHERE warehouse_code = 'WH-SEED-LTL-01';
