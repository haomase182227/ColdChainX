...
public sealed class AuthorizationIntegrationTests : IAsyncLifetime
{
    ...
    private sealed class IncidentServiceStub : IIncidentReportService
    {
        ...
        public Task<ApiResponse<IncidentRiskAssessmentResponse>> AssessRiskAsync(Guid incidentId, AssessIncidentRiskRequest request, Guid userId) => throw new NotSupportedException();
        ...
        public Task<int> EscalateOverdueReportedIncidentsAsync(DateTime asOf) => throw new NotSupportedException();
    }
    ...
    private sealed class DashboardServiceStub : IDashboardService
    {
        ...
        public Task<ApiResponse<AdminOverviewResponse>> GetAdminOverviewAsync(DateTime? fromDate, DateTime? toDate, Guid? warehouseId, Guid? routeId, string? groupBy = "WEEK", int top = 10, CancellationToken cancellationToken = default)
