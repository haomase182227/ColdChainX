...
-- 1. TẠO CÁC NHÓM PHÂN LOẠI TIN NHẮN (MessageType)
INSERT INTO MessageType (Type_Name, Description) 
VALUES 
    ('ORDER_STATUS', 'Cập nhật trạng thái đơn hàng, báo giá, hợp đồng'),
    ('DELIVERY_ALERT', 'Cảnh báo sự cố trên đường, nhiệt độ, thay đổi thời gian ETA'),
    ('SYSTEM_INFO', 'Thông báo từ hệ thống, nhắc nhở hạn giấy tờ');

-- 2. TẠO CÁC TEMPLATE THÔNG BÁO
INSERT INTO Notification_Templates (Template_ID, Type_ID, Title_Template, Body_Template, Channel, Status) 
VALUES 
    (
        'NOTI_ORDER_NEW',
        (SELECT Type_ID FROM MessageType WHERE Type_Name = 'ORDER_STATUS'),
        'Đơn hàng mới: {{Tracking_Code}}',
        'Hệ thống vừa tiếp nhận yêu cầu vận chuyển mới (Mã đơn: {{Tracking_Code}}). Vui lòng kiểm tra chứng từ và tiến hành làm báo giá.',
        'IN_APP',
        'ACTIVE'
    ),
    (
        'NOTI_ORDER_REJECTED',
        (SELECT Type_ID FROM MessageType WHERE Type_Name = 'ORDER_STATUS'),
        'Đơn hàng {{Tracking_Code}} chưa hợp lệ',
        'Yêu cầu vận chuyển {{Tracking_Code}} của bạn đã bị từ chối. Lý do: {{Reject_Reason}}. Vui lòng chỉnh sửa hoặc liên hệ lại với Sales.',
        'IN_APP',
        'ACTIVE'
    ),
    (
        'NOTI_QUOTATION_SENT',
        (SELECT Type_ID FROM MessageType WHERE Type_Name = 'ORDER_STATUS'),
        'Có báo giá mới: Đơn hàng {{Tracking_Code}}',
        'Đơn hàng {{Tracking_Code}} của bạn đã được duyệt và có báo giá mới. Tổng chi phí dự kiến: {{Final_Amount}} VNĐ. Vui lòng xem và xác nhận báo giá.',
        'IN_APP',
        'ACTIVE'
    ),
    (
        ...
        (SELECT Type_ID FROM MessageType WHERE Type_Name = 'ORDER_STATUS'),
        'Khách hàng đã chốt giá: {{Tracking_Code}}',
        'Khách hàng đã xác nhận đồng ý báo giá cho đơn hàng {{Tracking_Code}}. Vui lòng chuyển sang bước làm hợp đồng.',
        'IN_APP',
        'ACTIVE'
    ),
    (
...
-- 3. Insert vào bảng Quản lý Kho bãi
INSERT INTO Warehouses (Warehouse_Name, Address, Max_Pallets, Current_Pallets, Status)
VALUES 
    ('Kho lạnh Phú Mỹ Hưng', '125 Thích Quảng Đức, Thủ Dầu Một, Hồ Chí Minh', 5000, 0, 'ACTIVE');

-- 4. Insert Bảng Giá Cước (Pricing_Matrix)
INSERT INTO Pricing_Matrix (Origin_City, Dest_City, Pricing_Unit, Unit_Price, Effective_Date) 
VALUES 
    ('Ho Chi Minh', 'Ho Chi Minh', 'KG', 1200.00, '2026-06-01'),
    ('Ho Chi Minh', 'Ho Chi Minh', 'CBM', 300000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Ho Chi Minh', 'TRIP_1.5T', 1200000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Binh Duong', 'KG', 1500.00, '2026-06-01'),
    ('Ho Chi Minh', 'Binh Duong', 'CBM', 380000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Binh Duong', 'TRIP_2.5T', 1800000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Dong Nai', 'KG', 1800.00, '2026-06-01'),
    ('Ho Chi Minh', 'Dong Nai', 'CBM', 420000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Dong Nai', 'TRIP_5T', 2800000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Can Tho', 'KG', 2500.00, '2026-06-01'),
    ('Ho Chi Minh', 'Can Tho', 'CBM', 650000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Can Tho', 'TRIP_5T', 4500000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Kien Giang', 'KG', 3500.00, '2026-06-01'),
    ('Ho Chi Minh', 'Kien Giang', 'CBM', 900000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Da Nang', 'KG', 6500.00, '2026-06-01'),
    ('Ho Chi Minh', 'Da Nang', 'CBM', 1600000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Da Nang', 'TRIP_5T', 16000000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Ha Noi', 'KG', 9500.00, '2026-06-01'),
    ('Ho Chi Minh', 'Ha Noi', 'CBM', 2800000.00, '2026-06-01'),
    ('Ho Chi Minh', 'Ha Noi', 'TRIP_5T', 26000000.00, '2026-06-01');

-- 5. Insert Bảng Phân Quyền Vai Trò (Roles)
INSERT INTO Roles (Role_Name, Description) 
VALUES 
    ('Admin', 'Quản trị viên hệ thống, có toàn quyền truy cập và cài đặt hệ thống'),
    ('Manager', 'Quản lý, giám sát hoạt động và phê duyệt các quy trình'),
    ('Dispatcher', 'Điều phối viên, phụ trách ghép chuyến, xếp xe và theo dõi vận hành'),
    ('Driver', 'Tài xế, sử dụng App Mobile để nhận chuyến, check-in và giao hàng'),
    ('Customer', 'Khách hàng đối tác, truy cập Web Portal để tạo đơn, xem báo giá và theo dõi lộ trình'),
    ('Sales', 'Nhân viên Kinh doanh / CSKH, xử lý báo giá, hợp đồng và giải quyết khiếu nại');
